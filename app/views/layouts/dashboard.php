  ...
  <aside class="w-72 bg-white border-r border-gray-200 flex flex-col flex-shrink-0 transition-all duration-300 hidden md:flex">
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1 no-scrollbar">
        ...
        <div class="pt-4">
            ...
            <a href="<?= $base ?>/laporan/create" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-150 <?= strpos($_SERVER['REQUEST_URI'], '/laporan/create') !== false ? 'bg-gray-50 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' ?>">
            ...
            <a href="<?= $base ?>/laporan/saya" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-150 <?= strpos($_SERVER['REQUEST_URI'], '/laporan/saya') !== false ? 'bg-gray-50 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' ?>">
